                    ...
                    <div class="protocols">
                      ${i.map(t=>B`
                          <span class="protocol-badge">
                            ${t.service}
                            ${t.blueprints.length>1?B`<span class="variant-count"
                                  >${t.blueprints.length}</span
                                >`:""}
                          </span>
                        `)}
                    </div>
